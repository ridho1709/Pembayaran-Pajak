...
<html lang="en">
  <head>
    ...
    <title>Klik Pajak | Dashboard</title>
    <link
      rel="stylesheet"
    ...
    <link
      href="material/vendor/fontawesome-free/css/all.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">Klik<i class="text-warning">|Pajak</i></div>
        </a>
                ...
                >
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        ...
                        src="material/img/undraw_profile_1.svg"
                        alt="..."
                      />
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        class="rounded-circle"
                        src="material/img/undraw_profile_2.svg"
                        alt="..."
                      />
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        class="rounded-circle"
                        src="material/img/undraw_profile_3.svg"
                        alt="..."
                      />
    ...
    <!-- Page level plugins -->
    <script src="material/vendor/chart.js/Chart.min.js"></script>
